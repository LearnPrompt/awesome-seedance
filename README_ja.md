...
**検証済み Seedance 2.5 / 2.0 プロンプトライブラリ。** 427 ケースをすべて元投稿と照合、257 回のクロスモデル再テスト、14 個の再利用可能テンプレート、25 個のインストール可能な AI 動画 Skill。母体は goodcase.ai の動画・画像・UI・コピーにまたがる 1120 件の検証済み AI ケース。毎日同期し、新しいケースが毎日追加されます。
...
- [ギャラリー索引](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery.ja.md) - 全 427 ケースのプロンプト全文、全ページをここから。
- [Seedance 2.5](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-2-5.ja.md) - 45 件.
...
- [Seedance（バージョン未記載）、Part 1/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-1.ja.md) - 1–91 件目.
- [Seedance（バージョン未記載）、Part 2/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-2.ja.md) - 92–186 件目.
- [Seedance（バージョン未記載）、Part 3/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-3.ja.md) - 187–252 件目.
...
<td width="25%" valign="top" align="center"><b>🎭 対話とリップシンク</b><br><sub>テンプレート 1 件 · 検証済みケース 4 件</sub><br><br><a href="https://goodcase.ai/cases/noorlewisx-seedance-ai-b2d98861daf9"><img src="https://media.goodcase.ai/media/poster/noorlewisx-seedance-ai-b2d98861daf9.jpg" width="200" alt="Seedance Fifteen-Second Gym Vlog With Continuous Dialogue"></a><br><sub>Dialogue and performance beats</sub><br><a href="#-narrative-and-performanceテンプレート-2-件">テンプレートを見る</a> · <a href="https://goodcase.ai/cases/noorlewisx-seedance-ai-b2d98861daf9">トップケース</a></td>
</tr>
<tr>
...
| 9   | [<img src="https://media.goodcase.ai/media/poster/smartphone-beach-day-memories.jpg" width="120" alt="Beach Day Memories Shot on a Smartphone">](https://goodcase.ai/cases/smartphone-beach-day-memories)                                                                                                                              | [Beach Day Memories Shot on a Smartphone](https://goodcase.ai/cases/smartphone-beach-day-memories)                                                                                           | 2.0   | 94  | -                | [プロンプト](./docs/gallery-seedance-2-0-part-1.ja.md#beach-day-memories-shot-on-a-smartphone) · [元投稿](https://x.com/Goodmanprotocol/status/2079189509586260101)                            |
...
| 15  | [<img src="https://media.goodcase.ai/media/poster/boa-hancock-water-obstacle-race-prompt.jpg" width="120" alt="Boa Hancock Water Obstacle Race Prompt">](https://goodcase.ai/cases/boa-hancock-water-obstacle-race-prompt)                                                                                                             | [Boa Hancock Water Obstacle Race Prompt](https://goodcase.ai/cases/boa-hancock-water-obstacle-race-prompt)                                                                                   | 2.5   | 90  | ⚠️ 劣化 (スコア 66.3) | [プロンプト](./docs/gallery-seedance-2-5.ja.md#boa-hancock-water-obstacle-race-prompt) · [元投稿](https://x.com/Chengzilhy/status/2087458506123465088)                                         |
...
| 17  | [<img src="https://media.goodcase.ai/cases/34deb8da196d.jpg" width="120" alt="Seedance Two-Character 2D Anime: Little Kite">](https://goodcase.ai/cases/lianaalane-seedance-ai-d70d42733c55)                                                                                                                                           | [Seedance Two-Character 2D Anime: Little Kite](https://goodcase.ai/cases/lianaalane-seedance-ai-d70d42733c55)                                                                                | 未記載   | 90  | ✅ 再現 (スコア 90.4)  | [プロンプト](./docs/gallery-seedance-unversioned-part-1.ja.md#seedance-two-character-2d-anime-little-kite) · [元投稿](https://x.com/Lianaalane/status/2089563357074559014)                     |
...
| 21  | [<img src="https://media.goodcase.ai/media/poster/yesandyou-seedance-ai-2a9dc20c947d.jpg" width="120" alt="A Tiny Bird Emerging from Mud in a Glass Jar">](https://goodcase.ai/cases/yesandyou-seedance-ai-2a9dc20c947d)                                                                                                               | [A Tiny Bird Emerging from Mud in a Glass Jar](https://goodcase.ai/cases/yesandyou-seedance-ai-2a9dc20c947d)                                                                                 | 未記載   | 89  | -                | [プロンプト](./docs/gallery-seedance-unversioned-part-1.ja.md#a-tiny-bird-emerging-from-mud-in-a-glass-jar) · [元投稿](https://x.com/Yesandyou_/status/2090075447195480403)                    |
...
| 30  | [<img src="https://media.goodcase.ai/cases/70fd0a62397d.jpg" width="120" alt="White-Haired Woman and Giant Black Cat in a Ruined Bedroom">](https://goodcase.ai/cases/seedance-create-a-30-second-ultra-cinematic-supernatural-fantasy-sequence-photorealisti-6d87ff7834d3)                                                            | [White-Haired Woman and Giant Black Cat in a Ruined Bedroom](https://goodcase.ai/cases/seedance-create-a-30-second-ultra-cinematic-supernatural-fantasy-sequence-photorealisti-6d87ff7834d3) | 未記載   | 87  | -                | [プロンプト](./docs/gallery-seedance-unversioned-part-1.ja.md#white-haired-woman-and-giant-black-cat-in-a-ruined-bedroom) · [元投稿](https://x.com/Zyrellix/status/2097594855946113177)        |

## 🎬 全プロンプト

全 427 ケースのプロンプト全文は `docs/` 配下のギャラリーにあります（GitHub が描画できるようページ分割）。[ギャラリー索引](./docs/gallery.ja.md)から入るか、バージョンへ直接ジャンプ:

- Seedance 2.5 - 45 件: [全ギャラリー](./docs/gallery-seedance-2-5.ja.md)。
...
- Seedance（バージョン未記載） - 252 件: [Part 1（1–91 件目）](./docs/gallery-seedance-unversioned-part-1.ja.md) · [Part 2（92–186 件目）](./docs/gallery-seedance-unversioned-part-2.ja.md) · [Part 3（187–252 件目）](./docs/gallery-seedance-unversioned-part-3.ja.md)。
...
| 指標                    | 値                     |
| --------------------- | --------------------- |
| このリポジトリの Seedance ケース | 427                   |
| Seedance 2.5          | 45                    |
| Seedance 2.0          | 130                   |
| Seedance（バージョン未記載）    | 252                   |
| 作者数                   | 159                   |
| 他モデルでの再テスト            | 247 件 / 257 回         |
| 安定度スコア（測定済み）          | 245 件 / 平均 78.0       |
| 最終更新                  | 2026-09-14            |
| goodcase.ai 全カテゴリ     | 1120 件 / クリエイター 336 人 |
| goodcase.ai AI 動画     | 581 件                 |
