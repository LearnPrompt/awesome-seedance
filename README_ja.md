...
**検証済み Seedance 2.5 / 2.0 プロンプトライブラリ: 389 ケースをすべて元投稿と照合、257 回のクロスモデル再テスト、14 個の再利用可能テンプレート、インストール可能な Agent Skill 1 つ。goodcase.ai から同期し、新しいケースが毎日追加されます。**
...
- [ギャラリー索引](./docs/gallery.ja.md) - 全 389 ケースのプロンプト全文、全ページをここから。
- [Seedance 2.5](./docs/gallery-seedance-2-5.ja.md) - 43 件.
- [Seedance 2.0、Part 1/2](./docs/gallery-seedance-2-0-part-1.ja.md) - 1–95 件目.
- [Seedance 2.0、Part 2/2](./docs/gallery-seedance-2-0-part-2.ja.md) - 96–130 件目.
- [Seedance（バージョン未記載）、Part 1/3](./docs/gallery-seedance-unversioned-part-1.ja.md) - 1–94 件目.
- [Seedance（バージョン未記載）、Part 2/3](./docs/gallery-seedance-unversioned-part-2.ja.md) - 95–180 件目.
- [Seedance（バージョン未記載）、Part 3/3](./docs/gallery-seedance-unversioned-part-3.ja.md) - 181–216 件目.
...
<td width="33%" valign="top" align="center"><b>💥 Action, dance and effects</b><br><sub>テンプレート 3 件 · 検証済みケース 11 件</sub><br><br><a href="https://goodcase.ai/cases/seedance-25-diner-frozen-time-rewind"><img src="https://media.goodcase.ai/media/poster/seedance-25-diner-frozen-time-rewind.jpg" width="260" alt="Frozen Time and Rewind in a 1950s Diner"></a><br><sub>Templates driven by body mechanics, beat placement or a physics set-piece rather than by scene description.</sub><br><a href="#-action-dance-and-effectsテンプレート-3-件">テンプレートを見る</a> · <a href="https://goodcase.ai/cases/seedance-25-diner-frozen-time-rewind">トップケース</a></td>
</tr>
</table>
...
| 23  | [<img src="https://media.goodcase.ai/media/poster/youmind-travel-vlog-city-to-beach.jpg" width="120" alt="Handheld Travel Vlog From Apartment to Beach">](https://goodcase.ai/cases/youmind-travel-vlog-city-to-beach)                                                                                                                                       | [Handheld Travel Vlog From Apartment to Beach](https://goodcase.ai/cases/youmind-travel-vlog-city-to-beach)                                                                           | 2.5   | 88  | -                | [プロンプト](./docs/gallery-seedance-2-5.ja.md#handheld-travel-vlog-from-apartment-to-beach) · [元投稿](https://x.com/BubbleBrain/status/2083659648108990925)                                  |
...
| 28  | [<img src="https://media.goodcase.ai/media/poster/korean-fantasy-romance-drama.jpg" width="120" alt="Korean Fantasy Romance Drama">](https://goodcase.ai/cases/korean-fantasy-romance-drama)                                                                                                                                                                 | [Korean Fantasy Romance Drama](https://goodcase.ai/cases/korean-fantasy-romance-drama)                                                                                                | 2.0   | 87  | ⚠️ 劣化 (スコア 73.7) | [プロンプト](./docs/gallery-seedance-2-0-part-1.ja.md#korean-fantasy-romance-drama) · [元投稿](https://x.com/JuliaClarky/status/2079586851862835248)                                           |
| 29  | [<img src="https://media.goodcase.ai/media/poster/seedance-realism-that-makes-ordinary-life-feel-special-aa5751af1eff.jpg" width="120" alt="Realism That Makes Ordinary Life Feel Special">](https://goodcase.ai/cases/seedance-realism-that-makes-ordinary-life-feel-special-aa5751af1eff)                                                                  | [Realism That Makes Ordinary Life Feel Special](https://goodcase.ai/cases/seedance-realism-that-makes-ordinary-life-feel-special-aa5751af1eff)                                        | 未記載   | 87  | -                | [プロンプト](./docs/gallery-seedance-unversioned-part-1.ja.md#realism-that-makes-ordinary-life-feel-special) · [元投稿](https://x.com/Just_sharon7/status/2096109540924141746)                 |
| 30  | [<img src="https://media.goodcase.ai/media/poster/aiwithkhan-seedance-ai-9a5c5cbd518b.jpg" width="120" alt="A Girl Cycling Through a Korean Alley in Summer">](https://goodcase.ai/cases/aiwithkhan-seedance-ai-9a5c5cbd518b)                                                                                                                                | [A Girl Cycling Through a Korean Alley in Summer](https://goodcase.ai/cases/aiwithkhan-seedance-ai-9a5c5cbd518b)                                                                      | 未記載   | 87  | ✅ 再現 (スコア 85.4)  | [プロンプト](./docs/gallery-seedance-unversioned-part-1.ja.md#a-girl-cycling-through-a-korean-alley-in-summer) · [元投稿](https://x.com/AIwithkhan/status/2091175465037746522)                 |

## 🎬 全プロンプト

全 389 ケースのプロンプト全文は `docs/` 配下のギャラリーにあります（GitHub が描画できるようページ分割）。[ギャラリー索引](./docs/gallery.ja.md)から入るか、バージョンへ直接ジャンプ:
...
- Seedance（バージョン未記載） - 216 件: [Part 1（1–94 件目）](./docs/gallery-seedance-unversioned-part-1.ja.md) · [Part 2（95–180 件目）](./docs/gallery-seedance-unversioned-part-2.ja.md) · [Part 3（181–216 件目）](./docs/gallery-seedance-unversioned-part-3.ja.md)。
