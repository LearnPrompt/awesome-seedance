...
**検証済み Seedance 2.5 / 2.0 プロンプトライブラリ。** 462 ケースをすべて元投稿と照合、264 回のクロスモデル再テスト、14 個の再利用可能テンプレート、25 個のインストール可能な AI 動画 Skill。母体は goodcase.ai の動画・画像・UI・コピーにまたがる 1205 件の検証済み AI ケース。毎日同期し、新しいケースが毎日追加されます。
...
- [ギャラリー索引](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery.ja.md) - 全 462 ケースのプロンプト全文、全ページをここから。
...
- [Seedance（バージョン未記載）、Part 3/4](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-3.ja.md) - 191–262 件目.
- [Seedance（バージョン未記載）、Part 4/4](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-4.ja.md) - 263–276 件目.
...
全 462 ケースのプロンプト全文は `docs/` 配下のギャラリーにあります（GitHub が描画できるようページ分割）。[ギャラリー索引](./docs/gallery.ja.md)から入るか、バージョンへ直接ジャンプ:
...
- Seedance（バージョン未記載） - 276 件: [Part 1（1–90 件目）](./docs/gallery-seedance-unversioned-part-1.ja.md) · [Part 2（91–190 件目）](./docs/gallery-seedance-unversioned-part-2.ja.md) · [Part 3（191–262 件目）](./docs/gallery-seedance-unversioned-part-3.ja.md) · [Part 4（263–276 件目）](./docs/gallery-seedance-unversioned-part-4.ja.md)。
...
| 指標                    | 値                     |
| --------------------- | --------------------- |
| このリポジトリの Seedance ケース | 462                   |
| Seedance 2.5          | 56                    |
| Seedance 2.0          | 130                   |
| Seedance（バージョン未記載）    | 276                   |
| 作者数                   | 166                   |
| 他モデルでの再テスト            | 254 件 / 264 回         |
| 安定度スコア（測定済み）          | 252 件 / 平均 77.9       |
| 最終更新                  | 2026-09-18            |
| goodcase.ai 全カテゴリ     | 1205 件 / クリエイター 346 人 |
| goodcase.ai AI 動画     | 611 件                 |
