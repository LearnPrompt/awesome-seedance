...
- [Gallery index](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery.md) - All 462 cases with full prompts, every page in one place.
...
- [Seedance (version unspecified), part 3/4](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-3.md) - Cases 193–264.
- [Seedance (version unspecified), part 4/4](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-4.md) - Cases 265–276.
...
All 462 cases, with full prompts, live in the gallery under `docs/` (sharded so GitHub renders every page). Start from the [gallery index](./docs/gallery.md), or jump to a version:
...
- Seedance (version unspecified) - 276 cases: [Part 1 (cases 1–91)](./docs/gallery-seedance-unversioned-part-1.md) · [Part 2 (cases 92–192)](./docs/gallery-seedance-unversioned-part-2.md) · [Part 3 (cases 193–264)](./docs/gallery-seedance-unversioned-part-3.md) · [Part 4 (cases 265–276)](./docs/gallery-seedance-unversioned-part-4.md).
...
| Metric                         | Value                     |
| ------------------------------ | ------------------------- |
| Seedance cases in this repo    | 462                       |
| Seedance 2.5                   | 56                        |
| Seedance 2.0                   | 130                       |
| Seedance (version unspecified) | 276                       |
| Unique authors                 | 166                       |
