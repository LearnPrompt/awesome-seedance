...
**Verified Seedance 2.5 / 2.0 prompt library.** 427 cases checked against their original posts, 257 cross-model retests, 14 reusable templates and 25 installable AI-video Skills, drawn from goodcase.ai's 1120 verified AI cases across video, image, UI and copy. Synced daily, new cases land every day.
...
- [Gallery index](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery.md) - All 427 cases with full prompts, every page in one place.
- [Seedance 2.5](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-2-5.md) - 45 cases.
- [Seedance 2.0, part 1/2](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-2-0-part-1.md) - Cases 1–97.
- [Seedance 2.0, part 2/2](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-2-0-part-2.md) - Cases 98–130.
- [Seedance (version unspecified), part 1/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-1.md) - Cases 1–93.
- [Seedance (version unspecified), part 2/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-2.md) - Cases 94–189.
- [Seedance (version unspecified), part 3/3](https://github.com/LearnPrompt/awesome-seedance/blob/main/docs/gallery-seedance-unversioned-part-3.md) - Cases 190–252.
...
| 9   | [<img src="https://media.goodcase.ai/media/poster/smartphone-beach-day-memories.jpg" width="120" alt="Beach Day Memories Shot on a Smartphone">](https://goodcase.ai/cases/smartphone-beach-day-memories)                                                                                                                              | [Beach Day Memories Shot on a Smartphone](https://goodcase.ai/cases/smartphone-beach-day-memories)                                                                                           | 2.0         | 94   | -                         | [prompt](./docs/gallery-seedance-2-0-part-1.md#beach-day-memories-shot-on-a-smartphone) · [source](https://x.com/Goodmanprotocol/status/2079189509586260101)                            |
...
| 15  | [<img src="https://media.goodcase.ai/media/poster/boa-hancock-water-obstacle-race-prompt.jpg" width="120" alt="Boa Hancock Water Obstacle Race Prompt">](https://goodcase.ai/cases/boa-hancock-water-obstacle-race-prompt)                                                                                                             | [Boa Hancock Water Obstacle Race Prompt](https://goodcase.ai/cases/boa-hancock-water-obstacle-race-prompt)                                                                                   | 2.5         | 90   | ⚠️ degraded (score 66.3)  | [prompt](./docs/gallery-seedance-2-5.md#boa-hancock-water-obstacle-race-prompt) · [source](https://x.com/Chengzilhy/status/2087458506123465088)                                         |
...
| 17  | [<img src="https://media.goodcase.ai/cases/34deb8da196d.jpg" width="120" alt="Seedance Two-Character 2D Anime: Little Kite">](https://goodcase.ai/cases/lianaalane-seedance-ai-d70d42733c55)                                                                                                                                           | [Seedance Two-Character 2D Anime: Little Kite](https://goodcase.ai/cases/lianaalane-seedance-ai-d70d42733c55)                                                                                | unspecified | 90   | ✅ reproduced (score 90.4) | [prompt](./docs/gallery-seedance-unversioned-part-1.md#seedance-two-character-2d-anime-little-kite) · [source](https://x.com/Lianaalane/status/2089563357074559014)                     |
...
| 21  | [<img src="https://media.goodcase.ai/media/poster/yesandyou-seedance-ai-2a9dc20c947d.jpg" width="120" alt="A Tiny Bird Emerging from Mud in a Glass Jar">](https://goodcase.ai/cases/yesandyou-seedance-ai-2a9dc20c947d)                                                                                                               | [A Tiny Bird Emerging from Mud in a Glass Jar](https://goodcase.ai/cases/yesandyou-seedance-ai-2a9dc20c947d)                                                                                 | unspecified | 89   | -                         | [prompt](./docs/gallery-seedance-unversioned-part-1.md#a-tiny-bird-emerging-from-mud-in-a-glass-jar) · [source](https://x.com/Yesandyou_/status/2090075447195480403)                    |
...
| 30  | [<img src="https://media.goodcase.ai/cases/70fd0a62397d.jpg" width="120" alt="White-Haired Woman and Giant Black Cat in a Ruined Bedroom">](https://goodcase.ai/cases/seedance-create-a-30-second-ultra-cinematic-supernatural-fantasy-sequence-photorealisti-6d87ff7834d3)                                                            | [White-Haired Woman and Giant Black Cat in a Ruined Bedroom](https://goodcase.ai/cases/seedance-create-a-30-second-ultra-cinematic-supernatural-fantasy-sequence-photorealisti-6d87ff7834d3) | unspecified | 87   | -                         | [prompt](./docs/gallery-seedance-unversioned-part-1.md#white-haired-woman-and-giant-black-cat-in-a-ruined-bedroom) · [source](https://x.com/Zyrellix/status/2097594855946113177)        |

## 🎬 All Prompts

All 427 cases, with full prompts, live in the gallery under `docs/` (sharded so GitHub renders every page). Start from the [gallery index](./docs/gallery.md), or jump to a version:

- Seedance 2.5 - 45 cases: [Full gallery](./docs/gallery-seedance-2-5.md).
- Seedance 2.0 - 130 cases: [Part 1 (cases 1–97)](./docs/gallery-seedance-2-0-part-1.md) · [Part 2 (cases 98–130)](./docs/gallery-seedance-2-0-part-2.md).
- Seedance (version unspecified) - 252 cases: [Part 1 (cases 1–93)](./docs/gallery-seedance-unversioned-part-1.md) · [Part 2 (cases 94–189)](./docs/gallery-seedance-unversioned-part-2.md) · [Part 3 (cases 190–252)](./docs/gallery-seedance-unversioned-part-3.md).
...
| Metric                         | Value                     |
| ------------------------------ | ------------------------- |
| Seedance cases in this repo    | 427                       |
| Seedance 2.5                   | 45                        |
| Seedance 2.0                   | 130                       |
| Seedance (version unspecified) | 252                       |
| Unique authors                 | 159                       |
| Re-run on other models         | 247 cases / 257 runs      |
| Stability score (measured)     | 245 cases / avg 78.0      |
| Last updated                   | 2026-09-14                |
| goodcase.ai, all categories    | 1120 cases / 336 creators |
| goodcase.ai, AI video          | 581 cases                 |
